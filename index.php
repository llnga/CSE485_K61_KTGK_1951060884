	...
	<p id="success"></p>
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
				...
				<td>
							<span class="custom-checkbox">
								<input type="checkbox" class="user_checkbox" data-user-id="<?php echo $row["d_id"]; ?>">
								<label for="checkbox2"></label>
							</span>
						</td>
					<td><?php echo $i; ?></td>
					<td><?php echo $row["d_name"]; ?></td>
					<td><?php echo $row["d_sex"]; ?></td>
					<td><?php echo $row["d_age"]; ?></td>
					<td><?php echo $row["d_address"]; ?></td>
					<td><?php echo $row["d_email"]; ?></td>
					<td><?php echo $row["d_phone"]; ?></td>
					<td><?php echo $row["d_bgrp"]; ?></td>
			...
			<div class="modal-content">
				<form action="backend/save.php" method="POST">
					...
					<div class="modal-footer">
						<button type="submit" class="btn btn-success" id="btn-add" name='save'>Add</button>
					</div>
				</form>
			</div>
		</div>
